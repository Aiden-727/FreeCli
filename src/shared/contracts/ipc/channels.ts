export const IPC_CHANNELS = {
  ...
  appLifecyclePrepareWindowClose: 'app-lifecycle:prepare-window-close',
  appLifecycleWindowClosePrepared: 'app-lifecycle:window-close-prepared',
  ...
  pluginsEyeCareSyncSettings: 'plugins:eye-care:sync-settings',
  pluginsEyeCareGetState: 'plugins:eye-care:get-state',
  pluginsEyeCareStartCycle: 'plugins:eye-care:start-cycle',
  pluginsEyeCarePause: 'plugins:eye-care:pause',
  ...
  pluginsGitWorklogRefreshWorkspace: 'plugins:git-worklog:refresh-workspace',
  pluginsGitWorklogRepairRepositories: 'plugins:git-worklog:repair-repositories',
  pluginsGitWorklogUndoRepositoryRepair: 'plugins:git-worklog:undo-repository-repair',
  pluginsGitWorklogAcceptPendingImport: 'plugins:git-worklog:accept-pending-import',
  pluginsGitWorklogDismissPendingImport: 'plugins:git-worklog:dismiss-pending-import',
  pluginsGitWorklogRestoreDismissedImport: 'plugins:git-worklog:restore-dismissed-import',
