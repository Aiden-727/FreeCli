      ...
      >
        ...
        {pluginWidgets ? (
          <div className="control-center__section">
            <div className="control-center__section-label">{t('controlCenter.plugins')}</div>
            <div className="control-center__tiles">{pluginWidgets}</div>
          </div>
        ) : null}
