export const zhCNSettingsPanel = {
  ...
  general: {
    ...
    resetData: {
      title: '清除本地数据',
      help: '清空当前实例的 userData 目录，用于排除本地缓存、数据库和插件历史造成的干扰。',
      scopeLabel: '清理范围',
      scopeHelp: '将清空：{{path}}',
      action: '清除并重启',
      confirmAction: '确认清除',
      clearing: '清除中…',
      failed: '清除本地数据失败：{{message}}',
      dialogTitle: '确认清除本地数据？',
      dialogSummary: '此操作会删除当前实例的本地数据库、插件缓存、日志和恢复数据。',
      dialogLead: '该操作不可撤销。应用会在清理完成后自动重启，并以全新的本地状态重新启动。',
    },
  },
  agent: {
    title: 'Agent',
  ...
  ai: {
    ...
    extensions: {
      title: 'Skills 与 MCP',
      summaryTitle: '扩展',
      summaryHelp: '管理全局 Skills 与 MCP。',
      providerTitle: '{{provider}} 扩展',
      providerHelp: '仅影响后续新会话。',
      cliAvailable: 'CLI 可用',
      cliUnavailable: 'CLI 不可用，已回退文件模式',
      configPath: '配置文件：{{path}}',
      skillsPath: 'Skills 目录：{{path}}',
      mcpTitle: 'MCP',
      mcpHelp: '查看和管理全局 MCP。',
      skillsTitle: 'Skills',
      skillsHelp: '查看和新建 Skills。',
      loading: '正在读取扩展配置…',
      enabled: '已启用',
      disabled: '已禁用',
      emptyMcp: '当前没有配置 MCP server。',
      emptySkills: '当前没有可发现的 skill。',
      removeMcp: '移除',
      addMcp: '新增 MCP',
      ...
      mcpNamePlaceholder: 'Server 名称',
      mcpUrlPlaceholder: 'https://example.com/mcp',
      mcpCommandPlaceholder: '命令，例如 npx',
      mcpArgsPlaceholder: '参数，例如 -y @modelcontextprotocol/server-postgres ...',
