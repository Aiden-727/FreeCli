...
export function getGraphicsModeLabel(t: TranslateFn, mode: GraphicsMode): string {
  if (mode === 'power-saving') {
    return t('settingsPanel.general.graphicsMode.powerSaving')
  }

  return t('settingsPanel.general.graphicsMode.systemDefault')
}
