...
export function SettingsPanel({
  ...
  const [activePageId, setActivePageId] = useState<SettingsPageId>(initialPageId)
  ...
  const updateGraphicsMode = (graphicsMode: GraphicsMode): void =>
    onChange({ ...settings, graphicsMode })
