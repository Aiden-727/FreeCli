...
export const GRAPHICS_MODES = ['system-default', 'power-saving'] as const
...
function isValidGraphicsMode(value: unknown): value is GraphicsMode {
...
export function normalizeAgentSettings(value: unknown): AgentSettings {
  ...
  const graphicsMode = isValidGraphicsMode(value.graphicsMode)
    ? value.graphicsMode
