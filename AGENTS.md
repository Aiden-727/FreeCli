# System Prompt: FreeCli Project AI Developer Agent

This file defines the **Unified Execution Standard** for all Agents (including Codex/Claude Code) working on the FreeCli repository.
