...
// 可通过 FREECLI_E2E_WINDOW_MODE 覆盖：inactive / offscreen / hidden。
...
process.env['FREECLI_E2E_WINDOW_MODE'] = resolveE2EWindowMode(
  process.env['FREECLI_E2E_WINDOW_MODE'],
)
const configuredTestMatch = process.env['FREECLI_E2E_TEST_MATCH']?.trim()
