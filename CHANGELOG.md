...
All notable changes to **FreeCli** will be documented in this file.
...
Welcome to FreeCli 0.0.3! This release focuses on workspace reliability, release pipeline hardening, and stronger recovery behavior across runtime and persistence boundaries.
...
Welcome to FreeCli 0.2.0! This release focuses on unifying the workspace experience, hardening runtime stability for AI Agents, and introducing formal multi-platform release pipelines.
...
- **Brand Standardization**: Standardized project branding, metadata, and release preparation tooling under the `FreeCli` identity.
...
We are thrilled to unveil the first public alpha of FreeCli! This release lays the foundation for a spatial, agent-native workspace built on top of Electron, React, and TypeScript. 
...
*For historical changes and detailed commit logs, please refer to the [commit history](https://github.com/Aiden-727/FreeCli/commits/main).*
