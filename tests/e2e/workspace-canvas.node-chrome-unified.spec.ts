...
test.describe('Workspace Canvas - Unified Node Chrome', () => {
  test('uses the same compact header height and button chrome across terminal, task, and note nodes', async () => {
    ...
    try {
      ...
      await expect(terminalNode).toHaveCSS('border-radius', '14px')
      await expect(terminalNode.locator('.terminal-node__resizer--top-left')).toHaveCSS(
        'border-top-left-radius',
        '14px',
      )
      await expect(terminalNode.locator('.terminal-node__resizer--top-right')).toHaveCSS(
        'border-top-right-radius',
        '14px',
      )
      await expect(terminalNode.locator('.terminal-node__resizer--bottom-left')).toHaveCSS(
        'border-bottom-left-radius',
        '14px',
      )
      await expect(terminalNode.locator('.terminal-node__resizer--bottom-right')).toHaveCSS(
