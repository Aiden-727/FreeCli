...
function resolveLaunchModes(windowMode?: E2EWindowMode): E2EWindowMode[] {
  const requestedMode =
    windowMode ?? parseWindowMode(process.env['FREECLI_E2E_WINDOW_MODE']) ?? 'offscreen'
  ...
  try {
    electronApp = await electron.launch({
      ...
      env: {
        ...
        FREECLI_TEST_WORKSPACE: testWorkspacePath,
        FREECLI_TEST_USER_DATA_DIR: userDataDir,
        FREECLI_TEST_AGENT_STUB_SCRIPT: testAgentStubScriptPath,
        FREECLI_E2E_WINDOW_MODE: launchMode,
