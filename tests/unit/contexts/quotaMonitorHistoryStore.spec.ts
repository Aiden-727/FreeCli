...
try {
  const module = await import(
    '../../../src/plugins/quotaMonitor/infrastructure/main/QuotaMonitorHistoryStore'
  )
...
describe('QuotaMonitorHistoryStore', () => {
  ...
  historyStoreIt('builds hourly and daily quota trends while estimating work duration from snapshot history', async () => {
